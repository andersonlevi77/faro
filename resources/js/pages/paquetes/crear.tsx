...
import { create, index, store } from '@/routes/paquetes';
...
export default function PaquetesCrear({ productos }: { productos: ProductoOption[] }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        precio_alquiler: '',
        activo: true,
        items: [{ producto_id: '' as number | '', cantidad: '1' }] as ItemForm[],
    });
