...
class RolePermissionSeeder extends Seeder
{
    ...
    public static function mapaPermisos(): array
    {
        return [
            ...
            'paquetes.viewAny' => 'Paquetes: listar',
            'paquetes.view' => 'Paquetes: ver detalle',
            'paquetes.create' => 'Paquetes: crear',
            'paquetes.update' => 'Paquetes: editar',
            'paquetes.delete' => 'Paquetes: eliminar',
